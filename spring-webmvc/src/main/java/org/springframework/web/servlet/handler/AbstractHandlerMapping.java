...
public abstract class AbstractHandlerMapping extends WebApplicationObjectSupport
	...
	/**
	 * 继承WebApplicationObjectSupport->ApplicationObjectSupport，所以入口在ApplicationObjectSupport.setApplicationContext
	...
	protected void initApplicationContext() throws BeansException {
		...
		//将容器里的MappedInterceptors添加到adaptedInterceptors中
	...
	public final HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
		//根据request获取一个指定的handler，如果没找到返回null，调用链路RequestMappingHandlerMapping.getHandlerInternal-->AbstractHandlerMethodMapping.getgetHandlerInternal
