...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			//设置startUpdate,将状态改为active，初始化properties
			prepareRefresh();

			// Tell the subclass to refresh the internal bean factory.
			//返回 DefaultListableBeanFactory 刷新beanfactory，注意：里面的refreshBeanFactory方法有俩个实现
			ConfigurableListableBeanFactory beanFactory = obtainFreshBeanFactory();

			// Prepare the bean factory for use in this context.
			//预处理，设置beanFactory,classloader spel 属性处理器 applicationAware 注入规则 applicationListerner 设置env等工作
			...
			try {
				...
				//执行容器以及用户BeanDefinitionRegistryPostProcessor以及BeanFactoryPostProcessor的postProcessBeanFactory方法
				...
				//模板方法，为子类提供自己的实现见GenericApplicationContext类
				onRefresh();

				// Check for listener beans and register them.
				//注册定义的ApplicationListener
				registerListeners();
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		//有俩个实现分别是，GenericApplicationContext和AbstractRefreshableApplicationContext
		refreshBeanFactory();
		return getBeanFactory();
	}
	...
	protected void registerBeanPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		//初始化注册所有BeanPostProcessor beans
